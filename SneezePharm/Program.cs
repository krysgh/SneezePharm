...
ServicosFornecedor fornecedor = new ServicosFornecedor();
ServicosPrincipioAtivo principioAtivo = new ServicosPrincipioAtivo();
ServicosMedicamento medicamento = new ServicosMedicamento();
ServicosVenda venda = new ServicosVenda();
ServicosProducao producao = new ServicosProducao();
...
void MenuCliente()
{
    ...
    do
    {
        opcao = Menu.Menus("=== Menu Cliente ===", menuCliente);
        ...
        switch (opcao)
        {
            case 1:
                ...
                break;
            case 2:
                cliente.ImprimirClienteLocalizado();
                break;
            case 3:
