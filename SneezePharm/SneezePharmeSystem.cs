...
{
    internal class SneezePharmeSystem
    {
        public List<Compra> Compras { get; private set; }
        public List<ItemCompra> ItensCompra { get; private set; }
        public List<PrincipioAtivo> PrincipioAtivos { get; private set; }

        public SneezePharmeSystem()
        {
            Compras = new List<Compra>();
            ItensCompra = new List<ItemCompra>();
            PrincipioAtivos = new List<PrincipioAtivo>();
        }
        ...
        public void IncluirCompra()
        {
            ...
            var cnpjCliente = Console.ReadLine();
            ...
            Compra compra = new(id, cnpjCliente, valorTotalItens);
        ...
        {
            return PrincipioAtivos.Find(x => x.Id == idPrincipioAtivo)!;
        }
        ...
        public void AlterarItemCompra()
        {
            ...
            Console.WriteLine("Caso nao queira alterar, aperte o enter!");
            Console.ResetColor();
